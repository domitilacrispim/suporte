...
<table border="1" style="text-align: right; width: 627px; height: 32px;">
	<tbody>
		<tr style="font-weight: bold;">
			<td> M�s: </td><td> Total de chamados: </td><td> Solu��es em tempo: </td><td> Solu��es fora do tempo: </td><td> Tempo m�dio (horas): </td>
		</tr>
...
//cria a query
$query = 'SELECT COUNT(*) as quantidade FROM ocorrencias o WHERE o.data_atendimento >= "'.$data_ini.'" AND o.problema = "'.$prob.'" AND o.data_atendimento < "'.$data_fim.'"' ;
//executa a query
...
echo "<a target='_self' href='problema_c.php?problema=".$prob."&mes_ini=".$i."&ano=".$ano."'>".$linha['quantidade']."</a>";
echo '</td>';
