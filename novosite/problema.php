...
<div class="menu" style="top: 40px">
<table border='0' style="text-align: left; background-color: #016867" cellpadding="2" cellspacing="2">
<tr>
<?php 
		...
		while ($linhaSistema = mysql_fetch_array($resultadoSistema)) { 
		  echo "\n<td><a target='_self' style='color:white;' href='problema_area.php?area=".$linhaSistema['sis_id']."'>".$linhaSistema['sistema']."</a></td>";
		  echo "\n<td>|</td>";
		}
?>
</tr>
...
<?php 
		...
		while ($linhaProblema = mysql_fetch_array($resultadoProblema)) { 
			echo "\n<tr>";
			echo "<td style='background-color: #016867;color:white;'>".$linhaProblema['sistema']."</td>";	
			echo "<td style='background-color: #016867;color:white;'>".$linhaProblema['problema']."</td>";	
