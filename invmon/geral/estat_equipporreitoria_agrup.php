<?
  ...
  */
	...
	$s_page_invmon = "estat_equipporreitoria_agrup.php";
...
######################################################################################
       ...
       print "<TABLE border='0' cellpadding='5' cellspacing='0' align='center' width='80%' bgcolor='$cor3'>";
		...
		print "<TABLE border='0' cellpadding='5' cellspacing='0' align='center' width='80%' bgcolor='$cor3'>";
        print "<TR><TD bgcolor=$cor3><b>Reitoria</TD><TD bgcolor=$cor3><b>Quantidade</TD><TD bgcolor=$cor3><b>Percentual</TD></tr>";        
        $i=0;
        $j=2;
  ...
  while ($row = mysql_fetch_array($resultado)) {
                ...
                ?>
                <TR>
                <TD bgcolor=<?print $color;?>><a href=mostra_consulta_comp.php?comp_tipo_equip=<?print $row['tipo']?>&comp_reitoria=<?print $row['cod_reitoria']?>&ordena=modelo,etiqueta title='Exibe a listagem de equipamentos cadastrados desse tipo para esse local.'><?print $row["reitoria"]?></TD>
				
				<TD bgcolor=<?print $color;?>><a href="estat_equipporreitoria.php"><?print $row["qtd"]?></a></TD>
