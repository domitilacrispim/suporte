<?
  ...
  */	
	...
	*/
		...
		print "<table border='0' cellspacing='1' summary=''";
	        ...
	        if ($linhasA==1){
                ...
                print "<TR><TD><B>Foi encontrado somente 1 modelo de configuração cadastrado no sistema.</B></TD></TR>";
        }
		print "</TD>";

        print "<TD>";
        print "<TABLE border='0' cellpadding='5' cellspacing='0' align='center' width='100%'>";
        print "<TR class='header'><TD><b>Fabricante</TD><TD><b>Modelo</TD><TD><b>Tipo</TD><TD><b>Alterar</TD><TD><b>Excluir</TD>";        
        $i=0;
        $j=2;
  ...
  while ($row = mysql_fetch_array($resultadoA)) {
                ...
                <td><? print $row["modelo"]?></td>
                
				<td><? print $row["equipamento"]?></td>
