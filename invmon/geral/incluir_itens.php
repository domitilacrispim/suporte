...
<BR>
<B>Inclusão de categoria de Hardware:</B>
<BR><br>
...
<TABLE border="0"  align="left" width="40%" bgcolor=<?print BODY_COLOR?>>
        <TR>
                ...
                <TD width="30%" align="left" bgcolor=<?print BODY_COLOR?>><INPUT type="text" class="text" name="hardware"></TD>
        </TR>
        ...
        <?
                if ($submit == "Cadastrar")
                {
                        ...
                        $query = "SELECT * FROM itens WHERE item_nome='$hardware'";
                        ...
                        if ($erro == "não")
                        {
                                $query = "INSERT INTO itens (item_nome) values ('$hardware')";
                                $resultado = mysql_query($query);
                                if ($resultado == 0)
                                {
