<?
  ...
  */
	...
	$s_page_invmon = "estat_compporprocessador.php";
...
######################################################################################
       ...
       print "<TABLE border='0' cellpadding='5' cellspacing='0' align='left' width='80%' bgcolor='$cor3'>";
					...
					print"<tr><TD></TD></tr>";
					print"<tr><TD></TD></tr>";
					print "<tr><td width=80% align=center><b>Quantidade de computadores por processador. <p>Unidade: $msgInst.</p></b></td></tr>";

  
        print "<TD>";
        print "<fieldset><legend>Computadores X processador</legend>";
		print "<TABLE border='0' cellpadding='5' cellspacing='0' align='center' width='80%' bgcolor='$cor3'>";
        print "<TR><TD bgcolor=$cor3><b>Equipamento</TD><TD bgcolor=$cor3><b>Processador</TD><TD bgcolor=$cor3><b>Quantidade</TD><TD bgcolor=$cor3><b>Percentual</TD></tr>";        
        $i=0;
        $j=2;
  ...
  while ($row = mysql_fetch_array($resultado)) {
				...
				<TD bgcolor=<?print $color;?>><a href=mostra_consulta_comp.php?comp_tipo_equip=<?print $row['tipo']?>&comp_proc=<?print $row['tipo_proc']?>&ordena=local,etiqueta title='Exibe a listagem de computadores cadastrados com esse tipo de processador.'><?print $row["processador"]?></a></TD>
