<?
  ...
  */session_start();
	...
	$_SESSION['s_page_admin'] = "itens.php";
	...
	if ((!isset($_GET['action'])) and !isset($_POST['submit'])){
		...
		print "<TD align='right'><a href='itens.php?action=incluir&tipo=".$tipo."'>Incluir Componente.</a></TD><BR>";
        ...
        else
        {
                ...
                print "<TD>";
                print "Existe(m) <b>".$linhas."</b> componente(s) cadastrado(s) no sistema.<br>";
                print "<TABLE border='0' cellpadding='5' cellspacing='0'  width='50%'>";
                print "<TR class='header'><TD>Tipo</TD><TD>Modelo</TD><TD><b>Alterar</b></TD><TD><b>Excluir</b></TD>";
                $j=2;
			...
			print "<td>".$row['mdit_fabricante']." ".$row['mdit_desc']." ".$row['mdit_desc_capacidade']." ".$row['mdit_sufixo']."</TD>";
                        print "<td><a onClick=\"redirect('itens.php?action=alter&cod=".$row['mdit_cod']."')\"><img height='16' width='16' src='".ICONS_PATH."edit.png' title='Editar o registro'></a></TD>";
                        print "<td><a onClick=\"confirma('Tem Certeza que deseja excluir esse unidade do sistema?','itens.php?action=excluir&cod=".$row['mdit_cod']."')\"><img height='16' width='16' src='".ICONS_PATH."drop.png' title='Excluir o registro'></a></TD>";
                        print "</TR>";
				}
                print "</TABLE>";
        }
