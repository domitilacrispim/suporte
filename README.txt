...
# OcoMon - versão 1.35
# Data: Março de 2006
# Autor: Flávio Ribeiro (flavio@lasalle.tche.br)
#
# Linceça: GPL
#
...
o arquivo é: _OCOMON_1.35_FULL.sql (em ocomon/install/1.35/)
...
Dentro do diretório do MYSQL no seu servidor digite:
mysql -uUSERNAME -p DATABASENAME < _OCOMON_1.35_FULL.sql (considerando que o script está dentro do diretório do mysql)
