...
print "<table class='topo' border='0px' id='cabecalho'>
    ...
    <td rowspan='2'><img src='MAIN_LOGO.png' height='81' width='502'>
...
if ($_SESSION['s_logado']){
	...
	print "</tr>";
		...
		//print "<br><br><br>";
		print "<tr><td><Usuá></Usuá>rio:</td><td><input type='text' class='help' name='login' value='".$_GET['usu']."' id='idLogin'></td></tr>
			...
			print "<tr><td colspan='3'>Abertura de Conta para Acesso aos Aplicativos do Hospital? Clique <a onClick=\"mini_popup('./ocomon/geral/newUser.php')\"><b><u><font color='#5e515b'>aqui!</font></u></b></a></td></tr>";		
		print "</table></td></tr>";
