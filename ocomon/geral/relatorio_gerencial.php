<?php
  ...
  */
	...
	$s_page_ocomon = "relatorio_gerencial.php";
...
else //if $ok==Pesquisar
{
       ...
       $d_fim_completa = $d_fim_nova.$hora_fim;
	    ...
	    { 
			...
			print "<table class='centro' cellspacing='0' border='0' >";
				...
				print "<tr><td>Horas válidas no período: </td><td>".$hValido." horas</td></tr>";
			print "</table><br><br>";
			...
			print "<blockquote>";			
			print "<table cellspacing='0' border='1'>";
			print "<tr><td><b></b></TD><td colspan='2' align='center'><b>INÍCIO DO PERÍODO</b></td><td colspan='2' align='center'><b>FINAL DO PERÍODO</b></td></tr>";
			print "<tr><td><b></b></TD><td>AGUARDANDO</td><td>EM ATENDIMENTO</td><td>AGUARDANDO</td><td>EM ATENDIMENTO</td></tr>";
		...
		while ($rowA = mysql_fetch_array($exec_qry_areasA)){
			...
			//----------------------- TABELA 1B --------------------//
			print "<tr><td>".$rowA['sistema']."</TD><td align='center'>".$row_aguardando_sw_ini['aguardando']."</td><td align='center'>".$tt_em_atendimento_sw_ini."</td><td align='center'>".$row_aguardando_sw_fim['aguardando']."</td><td align='center'>".$tt_em_atendimento_sw_fim."</td></tr>";
			//print "<tr><td>HARDWARE</TD><td align='center'>".$row_aguardando_hw_ini['aguardando']."</td><td align='center'>".$tt_em_atendimento_hw_ini."</td><td align='center'>".$row_aguardando_hw_fim['aguardando']."</td><td align='center'>".$tt_em_atendimento_hw_fim."</td></tr>";
			//--------------------------FINAL DA TABELA 1B--------------------//
			
		}	//FIM DO WHILE
			print "<tr><td><b>TOTAL</b></TD><td colspan='2'align='center'><b>".$tt_pendente_ini."</b></td><td colspan='2' align='center'><b>".$tt_pendente_fim."</b></td></tr>";						
			print "</table><br><br>";
			print "</blockquote>";
			### FIM DA TABELA
			...
			print "<blockquote>";
			print "<table cellspacing='0' border='1'>";
			print "<tr><td><b>ÁREA</b></td><td><b>SETOR</b></td><td><b>QUANTIDADE</b></td><td><b>MÉDIA POR EQUIPAMENTO</b></td></tr>";
			...
			while ($rowB = mysql_fetch_array($exec_qry_areasB)) {
				...
				//----------TABELA 2 -------------------//
					print "<tr><td colspan='1' rowspan='".$t_rowB."'>".$rowB['sistema']."</td>";
					while($rowC=mysql_fetch_array($exec_qry_ab_sw_setor)){
						//print "<tr><td>".$rowC['area']."</td><td>".$rowC['setor']."</td><td>".$rowC['quantidade']."</td>";
						print "<td>".$rowC['setor']."</td><td>".$rowC['quantidade']."</td>";
			...
			print "<blockquote>";
			print "<table cellspacing='0' border='1'>";
			print "<tr><td><b>ÁREA</b></td><td><b>SETOR</b></td><td><b>QUANTIDADE</b></td></tr>";
			...
			while ($rowD = mysql_fetch_array($exec_qry_areasD)) {
				...
				//----------TABELA 2 -------------------//
					print "<tr><td colspan='1' rowspan='".$t_rowD."'>".$rowD['sistema']."</td>";
					while($rowE=mysql_fetch_array($exec_qry_fe_sw_setor)){
						//print "<tr><td>".$rowC['area']."</td><td>".$rowC['setor']."</td><td>".$rowC['quantidade']."</td>";
						print "<td>".$rowE['setor']."</td><td>".$rowE['quantidade']."</td>";
						print "</tr>";		
					} // while
			...
			print "<blockquote>";
			print "<table cellspacing='0' border='1'>";
			print "<tr><td><b>ÁREA</b></td><td><b>USUÁRIO</b></td><td><b>SETOR</b></td><td><b>QUANTIDADE</b></td></tr>";
			...
			while ($rowF = mysql_fetch_array($exec_qry_areasF)) {
				...
				print "<tr><td colspan='1' rowspan='".$t_rowF."'>".$rowF['sistema']."</td>";
				while($rowG=mysql_fetch_array($exec_qry_us_sw)){
					print "<td>".$rowG['usuario']."</td><td>".$rowG['setor']."</td><td>".$rowG['quantidade']."</td></tr>";		
				} // while
			}
			print "</table><br><br>";
			print "</blockquote>";
			...
			print "<blockquote>";
			print "<table cellspacing='0' border='1'>";
			print "<tr><td><b>ÁREA</b></td><td><b>REITORIA</b></td><td><b>QUANTIDADE</b></td><td><b>PERCENTUAL</b></td><td><b>MÉDIA POR EQUIPAMENTO</b></td></tr>";
			...
			while ($rowH = mysql_fetch_array($exec_qry_areasH)){
				...
				print "<tr><td colspan='1' rowspan='".$t_rowH."'>".$rowH['sistema']."</td>";
				while($rowI=mysql_fetch_array($exec_qry_ab_sw_reit)){
					print "<td>".$rowI['reitoria']."</td><td>".$rowI['total']."</td><td>".$rowI['porcento']."</td>";		
		...
		//----------TABELA 9 -------------------//
			...
			print "<blockquote>";
			print "<table cellspacing='0' border='1'>";
			print "<tr><td><b>ÁREA</b></td><td><b>PROBLEMA</b></td><td><b>QUANTIDADE</b></td></tr>";		
			...
			while ($rowJ=mysql_fetch_array($exec_qry_areasJ)) {
				...
				print "<tr><td colspan='1' rowspan='".$t_rowJ."'>".$rowJ['sistema']."</td>";
				while($rowK=mysql_fetch_array($exec_qry_fe_sw_prob)){
					print "<td>".$rowK['problema']."</td><td>".$rowK['quantidade']."</td></tr>";		
				} // while
			}	
			print "</table><br><br>";
			print "</blockquote>";
			...
			print "<p>TOTAL DE EQUIPAMENTOS ETIQUETADOS E CADASTRADOS NO PERÍODO: <b>".$row_cadastrados['cadastrados']."</b></p><br>";
			...
			print "<blockquote>";
			print "<table cellspacing='0' border='1'>";
			print "<tr><td><b>TIPO</b></td><td><b>QUANTIDADE</b></td></tr>";
			print "<tr><td>SOFTWARE</td><td>".$row_sw_prev['preventivas']."</td></tr>";
			print "<tr><td>HARDWARE</td><td>".$row_hw_prev['preventivas']."</td></tr>";
			print "<tr><td><b>TOTAL</b></td><td><b>".$tt_prev."</b></td></tr>";			
			print "</table><BR><BR>";
			print "</blockquote>";
			//-------------FINAL DA TABELA 11 -----------//
			...
			/*
			$query_projetos = "select count(*) projetos from ocorrencias where problema in (90) and
					data_abertura >='".$d_ini_completa."' and data_fechamento <='".$d_fim_completa."'";
			$exec_projetos = mysql_query($query_projetos);
			$row_projetos = mysql_fetch_array($exec_projetos);
			print "TOTAL DE CHAMADOS PARA PESQUISA E DOCUMENTAÇÃO DE PROCESSOS: <b>".$row_projetos['projetos']."</b><br><br>";	
			*/
			...
			print "<blockquote>";
			print "<table cellspacing='0' border='1'>";
			print "<tr><td><b>REITORIA</b></td><td><b>PERCENTUAL</b></td></tr>";			
			while($row=mysql_fetch_array($exec_equip_reit)){
				print "<tr><td>".$row['reitoria']."</td><td>".$row['porcento']."</td></tr>";	
			} // while			
			print "</table><BR><BR>";
			print "</blockquote>";
			//--------------------FIM DA TABELA 12 ---------------//	
			...
			print "<blockquote>";
			print "<table cellspacing='0' border='1'>";
			print "<tr><td><b>SITUAÇÃO</b></td><td><b>QUANTIDADE</b></td></tr>";			
			print "<tr><td>EM GARANTIA DO FABRICANTE</td><td>".$row_em_garantia['EM_GARANTIA']."</td></tr>";
			print "<tr><td>EM CONTRATO</td><td>".$row_em_contrato['EM_CONTRATO']."</td></tr>";
			print "<tr><td>SUCATEADOS</td><td>".$row_sucata['SUCATA']."</td></tr>";
			print "</table><br><br>";
			print "</blockquote>";
			//----------------- FIM DA TABELA 13 ----------------//			
 ...
 //----------------------------------------------
			...
			print "<blockquote>";
			print "<table cellspacing='0' border='1'>";
			print "<tr><td><b>TIPO</b></td><td><b>MÉDIA DE RESPOSTA</b></td><td><b>MÉDIA DE SOLUÇÃO</b></td></tr>";			
			print "<tr><td>HARDWARE</td><td>".$media_resposta_valida_hw."</td><td>".$media_solucao_valida_hw."</td></tr>";						
			print "<tr><td>SOFTWARE</td><td>".$media_resposta_valida."</td><td>".$media_solucao_valida."</td></tr>";						
			print "</table><br><br>";
			print "</blockquote>";
			//------------ FINAL DA TABELA 15 -----------------//
			...
			print "<blockquote>";
			print "<table cellspacing='0' border='1'>";
			print "<tr><td><b>RESPOSTA</b></td><td><b>QUANTIDADE</b></td><td><b>PERCENTUAL</b></td></tr>";			
			print "<tr><td>ATÉ 30 MINUTOS</td><td>".$slaR_green."</td><td>".$perc_ate_slaR2."</td></tr>";						
			print "<tr><td>ATÉ 60 MINUTOS</td><td>".$slaR_yellow."</td><td>".$perc_ate_slaR3."</td></tr>";						
			print "<tr><td>MAIS DE 60 MINUTOS</td><td>".$slaR_red."</td><td>".$perc_mais_slaR3."</td></tr>";						
			print "</table>";
			...
			print "<blockquote>";
			print "<table cellspacing='0' border='1'>";
			print "<tr><td><b>SOLUÇÃO</b></td><td><b>QUANTIDADE</b></td><td><b>PERCENTUAL</b></td></tr>";			
			print "<tr><td>ATÉ 4 HORAS</td><td>".$sla_green."</td><td>".$perc_ate_sla2."</td></tr>";						
			print "<tr><td>ENTRE 4 E 6 HORAS</td><td>".$sla_yellow."</td><td>".$perc_ate_sla3."</td></tr>";						
			print "<tr><td>MAIS DE 6 HORAS</td><td>".$sla_red."</td><td>".$perc_mais_sla3."</td></tr>";						
			print "</table>";
			print "<input type='button' value='Gráfico' onClick=\"return popup('graph_geral_pizza.php?".$valores."&".$nome."&".$legenda."')\"><br><br>";
			print "</blockquote>";
			//------------ FINAL DA TABELA 17 -----------------//
			...
			print "<table cellspacing='0' border='1'>";
			print "<tr><td><b>RESPOSTA</b></td><td><b>QUANTIDADE</b></td><td><b>PERCENTUAL</b></td></tr>";			
			print "<tr><td>ATÉ 30 MINUTOS</td><td>".$slaR_green_hw."</td><td>".$perc_ate_slaR2_hw."</td></tr>";						
			print "<tr><td>ATÉ 60 MINUTOS</td><td>".$slaR_yellow_hw."</td><td>".$perc_ate_slaR3_hw."</td></tr>";						
			print "<tr><td>MAIS DE 60 MINUTOS</td><td>".$slaR_red_hw."</td><td>".$perc_mais_slaR3_hw."</td></tr>";						
			print "</table>";
			print "<input type='button' value='Gráfico' onClick=\"return popup('graph_geral_pizza.php?".$valores."&".$nome."&".$legenda."')\"><br><br>";
			print "</blockquote>";
			//------------ FINAL DA TABELA 18 -----------------//
			...
			print "<table cellspacing='0' border='1'>";
			print "<tr><td><b>SOLUÇÃO</b></td><td><b>QUANTIDADE</b></td><td><b>PERCENTUAL</b></td></tr>";			
			print "<tr><td>ATÉ 4 HORAS</td><td>".$sla_green_hw."</td><td>".$perc_ate_sla2_hw."</td></tr>";						
			print "<tr><td>ENTRE 4 E 6 HORAS</td><td>".$sla_yellow_hw."</td><td>".$perc_ate_sla3_hw."</td></tr>";						
			print "<tr><td>MAIS DE 6 HORAS</td><td>".$sla_red_hw."</td><td>".$perc_mais_sla3_hw."</td></tr>";						
			print "</table>";
			print "<input type='button' value='Gráfico' onClick=\"return popup('graph_geral_pizza.php?".$valores."&".$nome."&".$legenda."')\"><br><br>";
			print "</blockquote>";
			//------------ FINAL DA TABELA 19 -----------------//
			...
			print "<blockquote>";
			print "<table cellspacing='0' border='1'>";
			print "<tr><td><b>QUANTIDADE</b></td><td><b>INSTITUIÇÃO</b></td><td><b>ETIQUETA</b></td><td><b>LOCALIZAÇÃO</b></td></tr>";			
			while($row=mysql_fetch_array($exec_etiqueta_hw)){
				print "<tr><td>".$row['total']."</td><td>".$row['instituicao']."</td><td><a onClick= \"popup_alerta('../../invmon/geral/mostra_consulta_inv.php?comp_inst=".$row['inst_cod']."&comp_inv=".$row['etiqueta']."&popup=true')\">".$row['etiqueta']."</a></td><td>".$row['local']."</td></tr>";
			} // while
			print "</table><BR><br>";
			print "</blockquote>";
			//----------------------------- FIM DA TABELA 20 -------------------//
