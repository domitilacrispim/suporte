...
<?
  ...
  */
	...
	print "\n<BR><B>Abertura de ocorrências: ".$subCallMsg."</B><BR>";
	print "\n<FORM name='form1' method='POST' action='".$PHP_SELF."'  ENCTYPE='multipart/form-data'  onSubmit=\"return valida()\">";
	print "\n<TABLE border='0'  align='center' width='100%' bgcolor='".BODY_COLOR."'>";
