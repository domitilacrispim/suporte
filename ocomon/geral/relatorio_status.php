...
<BR>
<B>Relat�rio de ocorrências por status</B>
<BR>

<FORM method="POST" action=mostra_relatorio_status.php>
<TABLE border="1"  align="center" width="100%" bgcolor=<?print BODY_COLOR?>>
        ...
        <TABLE border="1"  align="center" width="100%" bgcolor=<?print TAB_COLOR?>>
                ...
                print "<option value=1000 selected>Em aberto</option>";
                $query = "SELECT * FROM status ORDER BY stat_id";
                ...
                <TD width="15%" align="left" bgcolor=<?print TD_COLOR?>>Per�odo de:</TD>
