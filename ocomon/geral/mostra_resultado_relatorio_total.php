...
<?
         ...
         if ($rodou == "sim")
         {
			...
			$query.="status !='$status' ";
                ...
                {
                        if ($j == 0)
                                print "<BR><B>OcoMon - Relat�rio -=- Foi(ram) encontrada(s) $linhas ocorrência(s).</B> - <a href=relatorio_total.php>Voltar</a><BR>";
                                print "<HR>";
                        ?>
                        <TABLE border="0"  align="center" width="100%">
                        <TR>
                                <TABLE border="0"  align="center" width="100%">
                                        <TD width="20%" align="left">N�mero:</TD>
                        ...
                        <TR>
                        <TABLE border="0"  align="center" width="100%">
                                <TD width="20%" align="left" valign="top">Descri��o:</TD>
                                ...
                                if ($linhas2!=0)
                                {
                                        ...
                                        while ($i < $linhas2)
                                        {
                                                ...
                                                <TABLE border="0"  align="center" width="100%">
                                                        ...
                                                        <TD width="10%" align="left" valign="top">Respons�vel:</TD>
