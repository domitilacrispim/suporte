...
<?
        ...
        print "<BR><B>OcoMon - Relat�rio de ocorrências por data de encerramento.</B> - <a href=relatorio_data_encerramento.php>Voltar</a><BR>";
        print "<HR>";
?>
<TABLE border="0"  align="center" width="100%">
        ...
        <TABLE border="0"  align="center" width="100%">
                ...
                <TD width="40%" align="left">N�mero total de ocorrências no banco de dados:</TD>
        ...
        <TR>
        <TABLE border="0"  align="center" width="100%">
                <TD width="60%" align="left">N�mero de ocorrências encerradas no per�odo de <?print datab($data_inicial);?> a <?print datab($data_final);?>:</TD>
