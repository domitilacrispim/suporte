<?php
  ...
  */
	...
	$s_page_ocomon = "relatorio_slas.php";
...
if ($ok != 'Pesquisar')   
{
	...
	print "					<td><INPUT name='d_ini' class='data'><a href=\"javascript:cal1.popup();\"><img height='14' width='14' src='../../includes/javascript/img/cal.gif' width='16' height='16' border='0' alt='Selecione a data'></a></td>";
	print "				</tr>";
	print "				<tr>";
	print "					<td bgcolor=".TD_COLOR.">Data Final:</td>";
	print "					<td><INPUT name='d_fim' class='data'><a href=\"javascript:cal2.popup();\"><img height='14' width='14' src='../../includes/javascript/img/cal.gif' width='16' height='16' border='0' alt='Selecione a data'></a></td>";
	print "				</tr>";
...
else //if $ok==Pesquisar
{
		    ...
		    if($linhas==0) 
			   {
				...
				#######################################################################
								...
								print "<tr id='linha".$cont."' onMouseOver=\"destaca('linha".$cont."');\" onMouseOut=\"libera('linha".$cont."');\" onMouseDown=\"marca('linha".$cont."')\">"; 
									print "<td><a onClick= \"javascript: popup_alerta('mostra_chamados.php?popup=true&numero=".$row['numero']."')\"><font color='blue'>$row[numero]</font></a></td>
                                            <td>$row[problema]</td>
	...
	#####################################################################################						
     ...
     ####################################################################################							
							...
							print "<tr><td><b>Solução acima de ".$sla16." horas:</b></TD><td><font color=".$corSla3."> <a href=\"#\" onClick= \"javascript: popup_alerta('mostra_chamados.php?popup=true&numero=".$chamados."')\">$c_slaS_16h</a> chamados = </font></TD><td><font color=".$corSla3.">$perc_sla16%</font></td><td></td></tr>";
							print "  <tr><td colspan=4><hr></td></tr>";			
                            ...
                            print "<tr><td><b>Resposta dentro do SLA:</td><td>".$c_slaR_blue." chamados</b></td><td>".$perc_blueR."%</td><td><img height='14' width='14' src='../../includes/imgs/sla1.png'></td></tr>";
                            print "<tr><td><b>Resposta até ".$percLimit."% acima do SLA:</td><td>".$c_slaR_yellow." chamados</b></td><td>".$perc_yellowR."%</td><td><img height='14' width='14' src='../../includes/imgs/sla2.png'></td></tr>";
                            print "<tr><td><b>Resposta acima de ".$percLimit."% do SLA:</td><td>".$c_slaR_red." chamados</b></td><td>".$perc_redR."%</td><td><img height='14' width='14' src='../../includes/imgs/sla3.png'></td></tr>";
