...
<?
        ...
        print "<BR><B>OcoMon - Relat�rio de ocorrências por status.</B> - <a href=relatorio_periodo_status.php>Voltar</a><BR>";
        print "<HR>";
?>
<TABLE border="0"  align="center" width="100%">
        ...
        while ($i < $linhas_status)
        {
                ...
                <TR>
                <TABLE border="0"  align="center" width="100%">
                        <TD width="20%" align="left"><?print mysql_result($resultado_status,$i,1);?>:</TD> //Foi alterado a posi��o de inicio 
	//no vetor
