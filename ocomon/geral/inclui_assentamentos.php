        ...
        <?
                if ($rodou == "sim")
                {
                        ...
                        else
                        {
                                ...
                                print "<TR><TD bgcolor=$cor1>N�mero</TD><TD bgcolor=$cor1>Problema</TD><TD bgcolor=$cor1>Contato</TD>
                                ...
                                while ($i < $linhas)
                                {
                                        ?>
                                        <TR>
                                        <TD bgcolor="white"><a href=assentamento.php?numero=<?print mysql_result($resultado,$i,0);?>><?print mysql_result($resultado,$i,0);?><a></TD>
                                        <?
                                        ...
                                        <TD bgcolor=<?print $color;?>><?print mysql_result($resultado3,0,1);?></TD>
                                        <?
                                                $data = datab(mysql_result($resultado,$i,9));
                                        ?>
                                        <TD bgcolor=<?print $color;?>><?print $data;?></TD>
                                        <?
                                                $status = mysql_result($resultado,$i,11);
                                                $query = "SELECT * FROM status WHERE stat_id='$status'";
                                                $resultado3 = mysql_query($query);
                                        ?>
                                        <TD bgcolor="white"><?print mysql_result($resultado3,0,1);?></TD>
                                        <?
                                        $i++;
                                }
                        }
