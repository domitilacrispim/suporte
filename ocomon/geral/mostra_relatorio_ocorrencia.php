...
<?
        ...
        print "<BR><B>OcoMon - Relat�rio de ocorrências por n�mero.</B> - <a href=relatorio_ocorrencias.php>Voltar</a><BR>";
        print "<HR>";
?>
<TABLE border="0"  align="center" width="100%">
        ...
        <TABLE border="0"  align="center" width="100%">
                ...
                <TD width="40%" align="left">N�mero total de ocorrências:</TD>
