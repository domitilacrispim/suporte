...
<BR><BR>
<B><center>::: CHAMADOS FECHADOS - SETORES X ÁREAS DE ATENDIMENTO :::</center></B>
<BR><BR>
<?php
	...
	print "							<option value=-1 selected>Relatório</option>";
...
else //if $ok==Pesquisar
{
	...
	else
	{
		...
		if($d_ini_completa <= $d_fim_completa)
			...
			print "\n<tr>
				<td colspan='2'><b>PERÍODO DE ".$d_ini." a ".$d_fim."</b></td>
				</tr>";
			print "</table>";		   
