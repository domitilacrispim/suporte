...
<?
        ...
        print "<BR><B>OcoMon - Relat�rio de ocorrências por operador.</B> - <a href=relatorio_operador.php>Voltar</a><BR>";
        print "<HR>";
?>
<TABLE border="0"  align="center" width="100%">
        ...
        <TR>
        <TABLE border="0"  align="center" width="100%">
                <TD width="34%" align="left"><?print mysql_result($resultado_op,0,0);?></TD>
