...
<?
        ...
        print "<BR><B>OcoMon - Relat�rio de ocorrências por data de abertura.</B> - <a href=relatorio_data_abertura.php>Voltar</a><BR>";
        print "<HR>";
?>
<TABLE border="0"  align="center" width="100%">
        ...
        <TR>
        <TABLE border="0"  align="center" width="100%">
                <TD width="60%" align="left">N�mero de ocorrências abertas no per�odo de <?print datab($data_inicial);?> a <?print datab($data_final);?>:</TD>
