...
<BR>
<B>Relat�rio para a Intranet do LaSalle</B>
<BR>

 <?
print"<B>Per�odo de $data_inicial a $data_final</B><br>";
            ...
            // echo $query; print "<br>";
              ...
              //  print "<br>*******";
               ...
               //  echo $sql;  print "<br>*******";
                ...
                print "<TD bgcolor=$cor1 align=right>Total di�rio</TD>";
                ...
                while ($data_i <= $data_final) {
                        ...
                        $semana = array(0=>"Domingo",1=>"Segunda",2=>"Ter�a",3=>"Quarta",4=>"Quinta",5=>"Sexta",6=>"S�bado");
                        $dia_semana = $semana[$s];
						...
						*/
						...
						if ( substr($dataAux,0,10) >= "2004-02-14" ) {
							// este dia houve hor�rio de ver�o. Por isto, tem que se somar 25horas
							$data_i = $data_i + 90000;
						} else {
                        	$data_i = $data_i + 86400;
							echo "joaoao - ";
