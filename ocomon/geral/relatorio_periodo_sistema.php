...
<BR>
<B>Relat�rio de ocorrências por �rea respons�vel:</B>
<BR>

<FORM method="POST" action=mostra_relatorio_periodo_sistema.php>
<TABLE border="1"  align="center" width="100%" bgcolor=<?print BODY_COLOR?>>
		<?php
                if ($msg=="dtinvalida") {
					echo "<TR><TD width=\"20%\" align=\"center\" bgcolor=".TD_COLOR."><B>Data Inv�lida!</B></TD></TR>";
                }
		?>
        <TR>
        <TABLE border="1"  align="center" width="100%" bgcolor=<?print TAB_COLOR?>>
                ...
                <TD width="30%" align="left" bgcolor=<?print BODY_COLOR?>><?print "<INPUT type=text name=data_inicial value=\"$di\" size=15 maxlength=15>";?></TD>
                <TD width="20%" align="left" bgcolor=<?print TD_COLOR?>>Data abertura (final):</TD>
                <TD width="30%" align="left" bgcolor=<?print BODY_COLOR?>><?print "<INPUT type=text name=data_final value=\"$df\" size=15 maxlength=15>";?></TD>
        </TABLE>
        </TR>
