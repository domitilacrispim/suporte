...
<?
		...
		$linhas = mysql_numrows($resultado);
                        if ($linhas==0)
                        {
                                $aviso = "Nenhuma solu��o localizada.";
                ...
                print "<TD>";
                if ($linhas>1)
                        print "<TR><TD><B>Foram encontradas $linhas solu��es poss�veis. </B></TD></TR>";
                else
                        print "<TR><TD><B>Foi encontrada somente 1 solu��o poss�vel.</B></TD></TR>";
                print "</TD>";
        ...
        while ($row = mysql_fetch_array($resultado))
        {
                ...
                <TABLE border="1" style="{border-collapse:collapse;} align="center" width="100%">
                       <tr> 
						<TD align="left" bgcolor=<?print TD_COLOR?>>N�mero:</TD>
