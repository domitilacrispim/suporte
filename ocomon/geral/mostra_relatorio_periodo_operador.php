...
<?
        ...
        print "<BR><B>OcoMon - Relat�rio de ocorrências por operador.</B> - <a href=relatorio_periodo_operador.php>Voltar</a><BR>";
        print "<HR>";
?>
<TABLE border="0"  align="center" width="100%">
        ...
        while ($i < $linhas_operador)
        {
                ...
                <TR>
                <TABLE border="0"  align="center" width="100%">
                        <TD width="20%" align="left"><?print mysql_result($resultado_operador,$i,1);?>:</TD>
                        <TD width="30%" align="left"><?print $linhas_oper;?></TD>
                        <TD width="20%" align="left">Percentual:</TD>
                        <TD width="30%" align="left"><?print round(($linhas_oper*100)/$linhas_total);?>%</TD>
                </TABLE>
                </TR>
                <?
                $i++;
