  ...
  */session_start();
	...
	if ($_POST['submit'] == "Cadastrar"){
		...
		if (!$erro)
		{
			...
			$query = "INSERT INTO problemas (problema, prob_area, prob_sla) values ('".noHtml($_POST['problema'])."', ".$_POST['area'].", ".$_POST['sla'].")";
	...
	if ($_POST['submit'] == "Alterar"){
		...
		$query2 = "UPDATE problemas SET problema='".noHtml($_POST['problema'])."', prob_area = ".$_POST['area'].", prob_sla = ".$_POST['sla']."  ".
